...
const (
	serviceName = "Chocolate Service"
	servicePort = "9003"
	serviceColor = "#6F4E37" // Brown/Chocolate color
)
...
func main() {
	...
	oauthConfig = &shared.OAuthConfig{
		ClientID:     "chocolate-service-client",  // Fixed client ID
		ClientSecret: "chocolate-service-secret",   // Fixed client secret
