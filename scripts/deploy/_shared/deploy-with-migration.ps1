# ============================================================
# Authway 전체 배포 + Migration 스크립트  [DEPRECATED]
# ============================================================
# DEPRECATED — 본 스크립트는 사용처가 없습니다 (Run-7 Cycle 26 sweep 확인).
# 신규 배포 흐름은 `prod/deploy-all.ps1` 또는 `staging/deploy-all.ps1`을 사용하세요.
# 그 안의 `deploy-all.core.ps1`이 단계 0에서 동일 마이그레이션을 호출합니다.
#
# 본 파일은 운영자 ad-hoc 디버깅용으로 보존되나, 다음 정리 PR에서 삭제 검토 대상입니다.
# Migration 시스템 통합 PR (PLAN-migration-system-consolidation.md) 머지 시 함께 삭제 권장.
# ============================================================
